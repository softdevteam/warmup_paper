...
parts of the data. For the particular, somewhat noisy, data we obtain, the
algorithm is somewhat over-sensitive to changes in the variance, particularly
for very small time values. Although we use a microsecond timer, our experience
...
left-to-right) if all their means variances overlap, and/or whose means are within
0.001s of each other.
