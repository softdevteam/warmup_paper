...
than expected by VM teams we have spoken to\edd{Although true, too anecdotal?}\laurie{yes, but i don't want another reviewer to say ``everyone knows this'', when we know that statement to be untrue. i'm open to other ways of tackling this though!}. Our results suggest
...
light of our findings, such optimisations may ineffective and possibly
deleterious.
...
We run on different machines and operating systems; whilst different
...
Although simple, these classifications allow us to tease apart unexpected
