...
similar to \bencherthree).\footnote{\laurie{this is incorrect, right?}\edd{we
have a full set of octane data, but only dacapo from bencher5 and if it
finishes in time}
The large amount of CPU time our
