...
classified as flat) some may consider it `good'. To avoid such subjectivity, we
consider an inconsistent benchmark to be: `bad', if any of its process executions
is \nosteadystate or \slowdown; or `neutral' if its process executions are
all \warmup or \flatc.
