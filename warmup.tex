...
the rates at which APERF and MPERF increment are undefined~\cite{intel17pstate}, though, in
practise, on our machines a fully busy core increments APERF per
clock tick (e.g.~ \bencherfive's CPU increments APERF at $3.6*10^9 Hz$).
