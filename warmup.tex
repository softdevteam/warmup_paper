...
are independent. In practise, some form of dependence was observed in only 11.8\% of our series
thus this affects a small portion of our data.  The consequences of this are limited 
for two
...
produce when dependence is present tend to demonstrate (on average) a small over-approximation. 
That is, if we want to be 99\% confident, we in fact are more than 99\% confident.  To understand 
this,
we ran a simulation study with the smallest (-0.968), largest (0.668) and mean (-0.215) 
dependence we observed.
For each value we created 1,000 simulations, the coverage of the 99\% confidence intervals were 
92\%, 100\% and 99.9\% respectively.  As a comparison simulated independent data (using the 
same seed) had coverage of 98.3\%.  Overall, despite
