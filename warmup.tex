...
\caption{Benchmark results. For processes which reach a steady state:
\emph{steady state iter} is the median in-process iteration that the steady
state was reached at; \emph{steady state secs} is the wall-clock time since the
