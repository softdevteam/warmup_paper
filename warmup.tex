...
and
\FPeval{\result}{round(\bencherfivevmbenchpairsgoodinconsistent+\bencherfivevmbenchpairsbadinconsistent,1)}%
\result\% are inconsistent
(with \bencherfivevmbenchpairsbadinconsistent\% of those being obviously `bad'); \bencherfive and
\benchersix are broadly similar. Taking \bencherseven as an example,
\benchersevenvmbenchpairsbadinconsistent\%
