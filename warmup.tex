...
\caption{\laurie{need an example with an outlier or two}An example of changepoint analysis, from execution \#0 of Fasta, V8
on \bencherthree. The changepoint analysis has detected two changepoints,
one early in the process execution, and one after iteration 500. The segment
means are shown as horizontal red lines, and show that an early improvement
in the benchmark performance was followed by a slowdown of approximately 0.32s.}
