...
order or other similar effects (see~\cite{mytkowicz09surprising}),
...
\caption{Main experiment results (1 of 2). \textsc{Key}: flat=\flatc,
...
\caption{Main experiment results (2 of 2). \textsc{Key}: flat=\flatc,
warmup=\warmup, slowdown=\slowdown, inconsistent=\inconsistent.}
\end{figure}
