...
\laurie{that is implied by ``steady state of peak performance'' (perhaps if we did this again we'd split the hypotheses apart, but we tested what we tested)}
...
\end{table*}
More subtly, it suggests that large programs which appear to have
