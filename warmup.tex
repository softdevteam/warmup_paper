...
loss of precision. \laurie{tomas points out that doing this during benchmarking
could interfere with FP performance. i think we do it after timing has stopped,
at which point it's probably not going to interfere in any way that we could
ever expect to observe.}
