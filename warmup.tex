...
validation system.\carl{hm, is a different system really enough? to follow what
machine learning does it would probably have to be a second set of benchmarks.}
...
Figure~\ref{fig:truncated}).\carl{I found the fact that the y-axis doesn't
start at 0\% quite misleading in this case, since it's a percentage. are things
too hard to see otherwise?} }
...
\end{minipage}
\caption{\sarah{EXAMPLES HAVE CHANGED! Please check before I do the Inkscape magic.} Comparing the changepoints and classifications of a
