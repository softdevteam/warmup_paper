...
\end{minipage}
\caption{\sarah{EXAMPLES HAVE CHANGED! Please check before I do the Inkscape magic.}\laurie{the RHS pexec still gets faster after iter 1000 (and the two pexecs have different y axes), which is confusing.} Comparing the changepoints and classifications of a
