...
segments (autocorrelation at lag 1 
equal to 0.134, 0 at larger lags)
%\laurie{i think we need to give an intuition about what ``similar 
%dependencies'' means. it 
%also seems that two simulations were run, one with dependent data and one with independent data? 
%i'm 
...
%this.  Unless you guys have a specific example or examples?}. 
Across 1,000 simulations the coverage of the 90\% confidence intervals was 86\% compared to 89\% 
when simulating independent data (using the same seed). This suggests there is a potential for 
slight over confidence in our estimates when dependence is present.  As some form of 
dependence was observed in only XX\% of our series this is a small effect on a small portion of 
our data.  Overall, despite
