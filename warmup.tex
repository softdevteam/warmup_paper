...
produce when dependence is present tend to be small under-approximations. To understand this,
we ran a simulation study with similar dependencies to those observed in our 
segments (lag 1 autocorrelation of 0.134 and 0 at larger lags).
Across 1,000 simulations the coverage of the 99\% confidence intervals was 97\%,
wherews simulated independent data (using the same seed) had coverage of 98.4\%.
As some form of dependence was observed in only \laurie{XXX\%} of our series
this is a small effect on a small portion of our data.  Overall, despite
