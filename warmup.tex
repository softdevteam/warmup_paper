...
iterations runners make, we cannot escape them entirely. We call
\texttt{clock\_gettime()} to obtain monotonic wall-clock time.
On both Linux and OpenBSD, this function contains what is effectively a spin-lock,
