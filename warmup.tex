...
Although not a VM, GCC serves as a baseline to compare the VMs against: GCC
should not exhibit little warmup behaviour since C code is ahead-of-time
compiled.\edd[final]{Simiarly CPython does no ahead of time compilation}
...
\edd{remove/replace since we don't pin anymore}
...
kernel as a precaution more than anything else.} of this effect.
