...
effect of many external events can add up: fortunately, a changepoint's variance
...
differences in the time taken to reach a steady state strongly suggests that VM benchmarking
should always include this measure. Fourth, we suspect that some of the odd
