...
assumption of indedendence, which our in-process iteration timings are clearly not.
\rebecca{I'm not happy with this sentence as PELT 
...
\laurie{ok. do you think you could draft a sentence that reflects this? i must admit i'm a bit 
confused! RK: done.}
...
segments (lag 1 autocorrelation of 0.134 and 0 at larger lags \laurie{would
it be clearer to say ``at lag 1 autocorrelation of 0.134 and at larger lags autocorrelation of 0''? 
RK: modified in this style but not exactly.}).
Across 1,000 simulations the coverage of the 90\% confidence \laurie{we use 99\% CIs in the paper. 
does that matter? RK: Yes, changed} intervals was 97\% compared to 98.4\% 
when simulating independent data (using the same seed). This suggests that our
confidence intervals will sometimes be under-approximates when dependence is
present. As some form of 
