...
complexity to a more manageable $\mathcal{O}(n^2)$ by noting that once an
``obvious'' changepoint has been discovered, it is not worth searching behind it
for further changepoints. Candidate segments are compared relative to their fit (defined
