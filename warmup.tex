...
classifications comparison succeeds, and we count the steady iter (\# or s) and
steady perf (s) as failing.
...
the classifications comparison succeeds, and we count the steady iter (\# or s) and
steady perf (s) as failing. If one of $P$ or $P_s$ contains
