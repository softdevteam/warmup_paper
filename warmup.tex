...
on these two machines, 209 (0.008\%) (spread over 6 process executions) failed
...
to deal with such aberrations, and 205 (98\%) of these in-process iterations are
...
\badinconsistent(29\warmup, 1\nosteadystate), it is likely that that
the \vmbpair would otherwise have been classified as warmup.
However, overall, the similar figures
