...
kernel~\cite{tickless}\edd{weird cite}, which requires recompiling the kernel with the
...
suite for JavaScript~\cite{octane}\edd{weird citation} (JavaScript). Octane was
