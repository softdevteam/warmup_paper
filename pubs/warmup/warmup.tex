...
here we discuss only the parts relevant to this paper's experiment. In the rest
...
Second, \krun monitors CPU temperature. Since modern CPUs change their behaviour
if they get too hot -- sometimes gradually throttling performance -- \krun
...
this threshold in 10 minutes, \krun terminates the entire experiment.
...
\subsubsection{The Iterations Runner}
