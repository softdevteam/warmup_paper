...
\laurie{i think this is no longer true, right?}\edd{Correct. We use ASLR mode 2, which is full ASLR} Finally, \krun disables Address Space Layout Randomisation (ASLR). While ASLR is
...
linear interpolation). Non-overlapping IQRs imply a meaningful difference in the steady iter (\#) or
...
plots to analyse \laurie{can we quantify this?}\edd{Something like "4192 plots" in brackets? I'll count up the pexecs at some point}, it is extremely unlikely that
