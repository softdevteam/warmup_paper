...
in this paper are often used to gauge the efficacy of VM optimisations. In
light of our findings, such optimisations may be ineffective and possibly
deleterious.
...
\begin{enumerate}
    \item We show that, even in a highly idealised setting, simple benchmarks
