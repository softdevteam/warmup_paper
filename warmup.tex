...
\begin{abstract}
Virtual Machines (VMs) with Just-In-Time (JIT) compilers are traditionally seen
to execute programs in two phases: the \emph{warmup} phase determines which
...
Performance numbers for JIT compiling VMs generally discard numbers from warmup,
focussing on peak performance. In this paper we run a number of small,
