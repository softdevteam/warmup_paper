...
segments (autocorrelation at lag 1 equal to 0.134, 0 at larger lags \laurie{would
it be clearer to say ``at lag 1 autocorrelation of 0.134 and at larger lags autocorrelation of 0''?}).
Across 1,000 simulations the coverage of the 90\% confidence \laurie{we use 99\% CIs in the paper. does that matter?} intervals was 86\% compared to 89\% 
