...
guarantee that the original confidence interval cover the `true' mean.
Thus sometimes the sampled \vmbpair pair might cover the `true' mean
while the original \vmbpair pair does not, or indeed neither may cover the `true'
mean. However, since we can't tell when
