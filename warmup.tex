...
\sarah{Note that Table 2 contains bencher7 data, and the text below refers to bencher5.}
...
instead of `a third`?} \sarah{I think this is \\benchersevenvmbenchpairsbadinconsistent}
of its \vmbpair pairs are `bad', clearly invalidating
Hypothesis H1.
...
with no definite timescale.} We therefore ran all our experiments with ASLR on.
...
on Linux. By measuring 30 process executions, we lessened, though did not
