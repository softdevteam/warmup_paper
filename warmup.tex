...
\laurie{tomas points out that the mean is $s$ but the variance is $s^2$... in a
sense, it's a semi-arbitrary choice, so maybe we should just say that}.
...
largest (0.668), and mean (-0.215) dependence we observed \laurie{tomas asks what the units are}. The coverage
