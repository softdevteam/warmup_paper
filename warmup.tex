...
than the VM \laurie{edd: it would be good to experiment with adding an example of two pexecs from the same (VM, benchmark, machine) triple where one pexec is warmup and the other flat}. Bad inconsistency is always more troubling: it
...
plots to analyse \laurie{can we quantify this?}, it is extremely unlikely that
