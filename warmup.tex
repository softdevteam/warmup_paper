...
`adaptive-tick mode' for as \laurie{this is really vague. doesn't it enable adaptive for all non-boot CPUs? or do you mean that adaptive can be turned on/off on some cores at run-time?} many logical CPUs as possible.\footnote{Not all
