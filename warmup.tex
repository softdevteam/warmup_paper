...
We first need to exclude idle cores from any checks. Although formally APERF is
an opaque value, in practise a fully busy core has
...
specific in mind to change it to?}. Based on this, we define the
