...
e.g.~\cite{barrett15approaches,grimmer15dynamically}). While
a real improvement over straightforward benchmarking methodologies,
there remain cases where it remains hard to produce
satisfying benchmarking statistics. Crucially, the methodology does not
provide a guaranteed repeatable way of determining when warmup has completed. Because of this
