...
iterations runner makes to the OS, two \edd{wrong} calls to \texttt{clock\_gettime} remain.
...
the multi-threading use by some VMs (e.g. JRuby/Truffle) for compilation, GC,
