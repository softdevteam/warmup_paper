...
means 2 of the process executions were slowdown, and 8 warmup, \goodinconsistent
means the process executions were inconsistent, but contained no slowdowns or no steady states). For processes
