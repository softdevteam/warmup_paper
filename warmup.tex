...
% Citation overrides. Some citations come out nasty in author/year mode.
% Use citetalias or citepalias to use an alias.
\defcitealias{tickless}{Linux 2016}
\defcitealias{octane}{Google 2012}
...
kernel~\citepalias{tickless}, which requires recompiling the kernel with the
...
suite for JavaScript~\citepalias{octane}. Octane was
