...
Second, it runs benchmarks on an isolated CPU core, to minimise the effect of
context switching. We achieved through Linux's \texttt{isolcpus} kernel
argument.
