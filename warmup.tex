...
\goodinconsistent  & \bencherthreevmbenchpairsgoodinconsistentpercentage\% & \bencherfivevmbenchpairsgoodinconsistentpercentage\% & \benchersixvmbenchpairsgoodinconsistentpercentage\% \\
\badinconsistent  & \bencherthreevmbenchpairsbadinconsistentpercentage\% & \bencherfivevmbenchpairsbadinconsistentpercentage\% & \benchersixvmbenchpairsbadinconsistentpercentage\% \\
\midrule
...
\result\% respectively, though the latter runs fewer benchmarks). Fewer \vmbpair pairs than process executions have `good'
warmup because some inconsistent \vmbpair pairs have some `good' warmup
process executions. On \bencherthree
\bencherthreevmbenchpairsslowdownpercentage\% of \vmbpair pairs slowdown
and \sarah{was: \\bencherthreevmbenchpairsinconsistentpercentage\%} are inconsistent
