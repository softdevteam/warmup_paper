...
\caption{Examples of a benchmarks with cycles.\laurie{let's not show gcc stuff in the draft paper. it raises more questions than we can/want to answer.}}
...
\caption{Example of a benchmark with late phase changes.\laurie{this isn't really a `late' phase change, as much as many phase changes (which, probably, continue on changing for infinity)}}
