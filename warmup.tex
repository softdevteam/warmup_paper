...
checking whether means and confidence intervals overlap \emph{I'm not sure you
can say two means overlap. That would be straight equality. Do you mean that
the interval for a measure of the mean overlaps?}.
...
then the classifications comparison succeeds
...
the classifications comparison fails but
the steady iter (\# or s) and steady perf (s) comparisons are made as
before.

The main complication comes from no steady state process executions. If
