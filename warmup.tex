...
\renewcommand{\sparklineheight}{1.75}  % 1.75 by default.
...
when comparing a segment $s_i$ against the final segment $s_f$: if the mean of $s_i$
is within the mean of $s_f$ $\pm$ $s_f$'s variance or 0.001s (whichever
