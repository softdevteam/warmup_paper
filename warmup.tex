...
the rates at which APERF and MPERF increment are opaque with only the APERF /
MPERF ratio being strictly defined~\cite{intel17pstate}, in
practise on our machines a fully busy core increments APERF proportional to the CPU base
