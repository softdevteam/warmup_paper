...
\sarah{This first paragraph is rather repetitive, maybe it can be omitted?}
...
$n$ to be a hard-coded number, e.g.~5. \sarah{Can we cite an example of someone picking a low n?}
...
\sarah{What about glibc versions?}
...
with the same system temperatures;\sarah{Same temp or within a tolerance of X per cent?}
