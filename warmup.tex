...
\caption{An example showing a speed-up due to JIT compilation and
(surprisingly) no garbage collection for the whole in-process execution.}
\label{fig:examples:goodcomp}
\end{figure}
