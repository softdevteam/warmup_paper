...
\emph{process executions}. Note that we deliberately treat VMs as black
...
Our results show that the traditional view of warmup is badly out of date---if
it ever held at all. We are not aware that anyone has systematically noted this
problem before, let alone take it into account when benchmarking. This suggests
that many published VM benchmarks (including our own) will have presented
...
unreliable data; it is likely that this has caused some ineffective, and perhaps even some deleterious,
