...
First time readers of this paper may find it easiest to read, in order,
Sections~\ref{sec:warmup}, \ref{sec:microbenchmarks}, \ref{sec:vms},
\ref{sec:stats}, \ref{sec:results}, \ref{sec:startup}, \ref{sec:related}, and
\ref{sec:conclusions} before on a second read adding
Sections~\ref{sec:methodology} and \ref{sec:threats}.
