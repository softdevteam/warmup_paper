...
% The following line must be commented for arxiv, whose texlive 2016 uses
% an older acmart, which does not have this option.
...
\makeatletter
\def\@journalName{Draft}%
\def\@permissionCodeOne{Draft}%
\def\@copyrightpermission{Distributed by arXiv: \url{https://arxiv.org/abs/1602.00602}}%
\def\@acmPrice{0}%
\makeatother
