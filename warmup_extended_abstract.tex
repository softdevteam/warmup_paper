...
better understanding of the warmup behaviours we have observed. First,
automated classification of warmup behaviours would help guide us through the
vast amount of data we have collected.\footnote{We have already started this
task.} Second, VM instrumentation may help us understand the reason for an
unexpected such as a step or spike in a graph. Ideally we could pin VM events
such as compilation and GC to such artefacts. Third, using hardware debugging
facilities, such as performance counters, may help us to pin hardware events to
artefacts. Once these tasks have been completed, we may be in a position to
propose new benchmarking methodologies.
