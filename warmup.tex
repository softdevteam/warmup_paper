...
that our comparison only considers classifications: we have no sensible way of
comparing other information (e.g.~steady perf (s)) on truncated in-process
iterations. That said, it is clear that the quality of classifications
is heavily dependent on the VM(s) in question: if one is confident that the the VM(s) in question do not have
