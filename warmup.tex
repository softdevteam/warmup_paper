...
\FPeval{\result}{round(\benchersevenflatpercentage+\benchersevenwarmuppercentage+\benchersevengoodinconsistentpercentage,1)}%
\result\% of all process executions have `good' warmup (for comparison, \bencherfive
is
\bfiveresult\% and
\FPeval{\result}{round(\bencherfiveflatpercentage+\bencherfivewarmuppercentage+\bencherfivegoodinconsistentpercentage,1)}%
\result\% respectively and \benchersix is
\bsixresult\% and
\FPeval{\result}{round(\benchersixflatpercentage+\benchersixwarmuppercentage+\benchersixgoodinconsistentpercentage,1)}%
