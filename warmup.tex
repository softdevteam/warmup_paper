...
little more consistent on linux machines. Would you agree?}\laurie{no. they're a *lot* more consistent! the worse thing is that, even though a few of these could be ``oh well, changepoint analysis could do better on this one i suppose'', most appear to be completely genuine things happening in the data. i have no idea why.}
...
me.}\laurie{that's not a good reason not to do it. we already have a basic script which applies the automatic autocorrelation doo-dah. deriving statistics from that seems plausible.}
