...
\caption{Two examples of traditional, warmup behaviour. On the left-hand side, warmup is complete by in-process iteration 1; on the right-hand side by iteration \laurie{XXX}.}
