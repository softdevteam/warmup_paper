...
effect of many external events can add up. We used the
the square of the standard deviation as a proxy for this cumulative effect.
...
is within $\textrm{mean}(s_f) \pm \textrm{max}(\textrm{stddev}(s_f)^2, 0.001\textrm{s})$.
