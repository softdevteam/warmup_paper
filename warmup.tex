...
\sarah{I could not find anywhere in the paper that uses these macros that are
defined just before the abstract (bfiveresult, minone, etc.) Do we still need them?}
