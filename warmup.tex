...
\laurie{we should summarise: X\% are flat, Y\% are warmup etc.}

For each process execution, we create a series of plots with
in-process iterations as a common $x$-axis. Different plots have different $y$
...
has one per core. For run-sequence plots
